...
export default config({
  ...
  const [profitsControl, setProfitsControl] = useState(0)
  const [amountControl, setAmountControl] = useState(0)
  ...
  const [twoControl, setTwoControl] = useState(0)
  ...
  // 客服统计和人工核算公共组件
  function publics1 (judge, a, b, c, d, e) {
    const jurisdiction = JSON.parse(sessionStorage.getItem('react-admin_login_user'))
    if (jurisdiction.CompanyId == null && jurisdiction.TenantId == null) {
      if (judge) {
        a(b)
  ...
  useEffect(async () => {
    ...
    // 利润统计
    const profits = await props.ajax.post("Proj/ProfitSummary", convertToFormData({
      'StartDate': "",
      'CompletionDate': ""
    }), {
      errorModal: { okText: (getLange(props.loginUser?.id) == "zh_CN" ? "取消" : "Cancel"), width: "70%" }
    ...
    if (jurisdiction.CompanyId == null && jurisdiction.TenantId == null) {
      if (profits.X.length > 0) {
        setProfitX(profits.X)
        setProfitY(profits.Y)
      } else {
        setProfitsControl(1)
      }
    } else {
    ...
    const judge = JSON.stringify(statistics.Shipments == '{}')
    console.log(judge);
    ...
    const judge4 = JSON.stringify(statistics.CustomerSupportCases == '{}')
    ...
    const judge5 = JSON.stringify(statistics.CustomerSupportCases == '{}')
    publics1(judge5, setProcessedNum1, g, setWorkControl, setNotprocessedNum1, h)


    if (!judge, !judge1, !judge2, !judge3, !judge4, !judge5) {
      setTwoControl(1)
    }
      ...
      <ConfigProvider locale={antLocale}>
        <PageContent className={styles.root}>
          ...
          <div className='box column' styles>
            ...
            <div className={['two_div', twoControl == 1 ? 'hide' : '']}>
              <div className='two_top_div'>
                <RangePicker bordered={false}
                  format={dateFormat} style={{ width: '14vw', fontSize: '0.5vw' }} />
              </div>
              <div className='flex zydq'>
                <div className={['div_ flex column neirong piaoshu', votesControl == 1 ? 'hide' : '']}>
                ...
                <div className={['div_ flex column neirong zhongliang', weightControl == 1 ? 'hide' : '']}>
                  <div className='tow_top_div flex'>
                ...
                <div className={['div_ flex column neirong lirun', profiControl == 1 ? 'hide' : '']}>
                  <div className='tow_top_div flex'>
                ...
                <div className={['div_ flex column neirong jieyu', balancesControl == 1 ? 'hide' : '']}>
                  <div className='tow_top_div flex'>
                ...
                <div className={['div_ flex column neirong kefu', customerControl == 1 ? 'hide' : '']}>
                  <div className='tow_top_div flex'>
                ...
                <div className={['div_ flex column neirong hesuan', workControl == 1 ? 'hide' : '']}>
                  <div className='tow_top_div flex'>
            ...
            <div className='divVad three_div flex'>
              <div className={['divVad left_div flex', control == 1 ? 'hide' : '',]}>
                    ...
                    <TabPane
                      ...
                      <Row>
                        ...
                        <Col span={12} className="">
                          <div className={['move  flex', profitsControl == 1 ? 'move2' : 'move3']} style={{
              ...
              <div className={['divVad a ', profitsControl == 1 ? 'hide' : '', control == 1 ? 'right_div1' : 'right_div']}>
                ...
                <Echartszx getLange={getLange} loginUser={loginUser} profitX={profitX} profitY={profitY}></Echartszx>
              </div>

            </div>
            <div className='divVad four_div flex'>
              <div className={['left_div flex', amountControl == 1 ? 'hide' : '']}>
              ...
              <div className={['divVad a ', balanceControl == 1 ? 'hide' : '', amountControl == 0 ? 'right_div' : 'right_div1']}>
